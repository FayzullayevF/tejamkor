...
mixin _$ForgotPasswordState {
 ...
 ForgotPasswordStatus get status; String? get verifyToken; String? get resetToken; String? get error;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForgotPasswordState&&(identical(other.status, status) || other.status == status)&&(identical(other.verifyToken, verifyToken) || other.verifyToken == verifyToken)&&(identical(other.resetToken, resetToken) || other.resetToken == resetToken)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,status,verifyToken,resetToken,error);

@override
String toString() {
  return 'ForgotPasswordState(status: $status, verifyToken: $verifyToken, resetToken: $resetToken, error: $error)';
}
...
@useResult
$Res call({
 ForgotPasswordStatus status, String? verifyToken, String? resetToken, String? error
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? verifyToken = freezed,Object? resetToken = freezed,Object? error = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as ForgotPasswordStatus,verifyToken: freezed == verifyToken ? _self.verifyToken : verifyToken // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ForgotPasswordStatus status,  String? verifyToken,  String? resetToken,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.status,_that.verifyToken,_that.resetToken,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ForgotPasswordStatus status,  String? verifyToken,  String? resetToken,  String? error)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.status,_that.verifyToken,_that.resetToken,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ForgotPasswordStatus status,  String? verifyToken,  String? resetToken,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.status,_that.verifyToken,_that.resetToken,_that.error);case _:
  return null;
...
class _ForgotPasswordState implements ForgotPasswordState {
  const _ForgotPasswordState({required this.status, this.verifyToken, this.resetToken, this.error});
  

@override final  ForgotPasswordStatus status;
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? verifyToken = freezed,Object? resetToken = freezed,Object? error = freezed,}) {
