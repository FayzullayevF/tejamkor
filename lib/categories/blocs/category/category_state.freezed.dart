...
mixin _$CategoryState {
 ...
 CategoryStatus get status; List<CategoryModel> get categories; String? get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.categories, categories)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@useResult
$Res call({
 CategoryStatus status, List<CategoryModel> categories, String? errorMessage
});
...
/// Create a copy of CategoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? categories = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CategoryStatus status,  List<CategoryModel> categories,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CategoryStatus status,  List<CategoryModel> categories,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _CategoryState():
return $default(_that.status,_that.categories,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CategoryStatus status,  List<CategoryModel> categories,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _CategoryState() when $default != null:
return $default(_that.status,_that.categories,_that.errorMessage);case _:
  return null;
...
class _CategoryState implements CategoryState {
  const _CategoryState({required this.status, required final  List<CategoryModel> categories, this.errorMessage}): _categories = categories;
  

@override final  CategoryStatus status;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._categories, _categories)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
/// Create a copy of CategoryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? categories = null,Object? errorMessage = freezed,}) {
